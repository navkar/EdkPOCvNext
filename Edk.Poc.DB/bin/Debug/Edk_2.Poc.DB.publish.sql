...
GO
ALTER TABLE [dbo].[VehicleBodytype]
    ADD CONSTRAINT [FK_dbo.VehicleBodytype.vehicleModel] FOREIGN KEY ([vehicleModel]) REFERENCES [dbo].[VehicleModel] ([ID]);
...
GO
PRINT N'Creating [dbo].[FK_dbo.VehicleMake.vehicleYear]...';


GO
ALTER TABLE [dbo].[VehicleMake]
    ADD CONSTRAINT [FK_dbo.VehicleMake.vehicleYear] FOREIGN KEY ([vehicleYear]) REFERENCES [dbo].[VehicleYear] ([ID]);
...
GO
ALTER TABLE [dbo].[VehicleModel]
    ADD CONSTRAINT [FK_dbo.VehicleModel.vehicleMake] FOREIGN KEY ([vehicleMake]) REFERENCES [dbo].[VehicleMake] ([ID]);
...
insert into VehicleMake(vehicleYear, make) 
OUTPUT INSERTED.Id INTO @tt
values (@uId, 'AUDI');

SELECT @uId = TempID FROM @tt; 

insert into VehicleModel(vehicleMake, model) 
OUTPUT INSERTED.Id INTO @tt
values (@uId, 'A5 QUATTRO PRESTIGE');

SELECT @uId = TempID FROM @tt;

insert into VehicleBodytype(vehicleModel, bodyType) 
OUTPUT INSERTED.Id INTO @tt
